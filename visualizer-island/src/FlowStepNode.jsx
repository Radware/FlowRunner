...
// runtime-details slot. Ported from the wave2 spike. A real component with typed
// props and token-driven styling replaces Drawflow's innerHTML string templating.
            ...
            <div className="flow-node-inner">
                <div className="node-header">
                    ...
                    <div className="node-actions">
                        <button
                            className="btn-node-action btn-add-step-after"
                            title="Add step after"
                            onClick={(e) => {
                                e.stopPropagation();
                                data.onRequestAddStepAfter?.(id);
                            }}
                        >
                            {'+'}
                        </button>
...
// The app's execution results expose duration in a few shapes; tolerate any.
function runtimeDuration(runtime) {
    const ms = runtime.durationMs ?? runtime.duration ?? null;
